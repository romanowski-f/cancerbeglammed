...
<h4 class="mt-4">Here's how Expert Fit works:</h4>
<p>Browse our collection of favorites featuring surgery-specific styles. Every bra or camisole links directly to the same item on AnaOno’s website where you can learn more about the product, have access to their professional fitters, and complete your purchases.</p>

<p>Don’t forget to checkout their foobs. (Yes, we said foobs!)</p>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsmg" target="_blank"><h2 class="cbg-product__title">I Have Implants</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsmk" target="_blank"><h2 class="cbg-product__title">I Had Flap Recon</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsmn" target="_blank"><h2 class="cbg-product__title">I am Unilateral</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsmr" target="_blank"><h2 class="cbg-product__title">I Had a Mastectomy</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsn6" target="_blank"><h2 class="cbg-product__title">I Had a Lumpectomy</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsnc" target="_blank"><h2 class="cbg-product__title">I Have Flat Closure</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsne" target="_blank"><h2 class="cbg-product__title">I Am Au Natural</h2></a>
		</div>
	</div>
</li>
...
<li class="cbg-product-wrapper">
	<div class="cbg-product">
		...
		<div class="cbg-product__meta">
			<a href="http://shrsl.com/2wsnp" target="_blank"><h2 class="cbg-product__title">Shop All Bras</h2></a>
		</div>
	</div>
</li>
...
<div class="exclaimer text-right small" style="font-size: 14px">All images are used courtesy of AnaOno, LLC.  Images are Copyright of AnaOno, LLC.</div>